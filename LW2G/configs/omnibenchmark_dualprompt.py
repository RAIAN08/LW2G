...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--topk_old_subspace', default=1, type=int) 
    subparsers.add_argument('--threshold_pretrained', default=0.95, type=float) 

    subparsers.add_argument('--dataset_name', default='Omnibenchmark', type=str, help='dataset name')
    ...
    subparsers.add_argument('--dataset', default='Split-Omnibenchmark', type=str, help='dataset name')
    ...
    subparsers.add_argument('--num_tasks', default=25, type=int, help='number of sequential tasks') # 10
    ...
    subparsers.add_argument('--size', default=25, type=int,) # 10
    subparsers.add_argument('--length', default=5, type=int, ) # 20
    ...
    subparsers.add_argument('--batchwise_prompt', default=True, type=bool) # False
