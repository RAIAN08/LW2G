...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--dataset_name', default='cub', type=str, help='dataset name')
    ...
    subparsers.add_argument('--g_prompt_layer_idx', default=[0, 1], type=int, nargs="+",
                            help='the layer index of the G-Prompt')
    subparsers.add_argument('--use_prefix_tune_for_g_prompt', default=True, type=bool,
